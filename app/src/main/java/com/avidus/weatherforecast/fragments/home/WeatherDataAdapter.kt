...
import com.avidus.weatherforecast.data.WeatherData
import com.avidus.weatherforecast.databinding.ImageContainerCurrentWeatherBinding
import com.avidus.weatherforecast.databinding.ItemContainerCurrentLocationBinding
import com.avidus.weatherforecast.databinding.ItemContainerForecastBinding
...
class WeatherDataAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            INDEX_FORECAST -> ForecastViewHolder(
                ...
                ImageContainerCurrentWeatherBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
                )
    ...
    inner class CurrentWeatherViewHolder(
        private val binding: ImageContainerCurrentWeatherBinding
    ) : RecyclerView.ViewHolder(binding.root) {
        fun bind(currentWeather: CurrentWeather) {
            with(binding) {
              ...
              imageIcon.load("https:${currentWeather.icon}") {
                ...
                println("here we are, $currentWeather.chanceOfRain")
            }
        }
    }
